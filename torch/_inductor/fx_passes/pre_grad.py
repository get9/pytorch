...
PRE_GRAD_VERTICAL_FUSIONS: Dict[str, PatternMatcherPass] = dict()
pass_names = [
    "normalization_pass",
...
for pass_name in pass_names:
    PRE_GRAD_VERTICAL_FUSIONS[pass_name] = construct_pattern_matcher_pass(pass_name)
# split_cat related fusions
pattern_matcher_passes = list(PRE_GRAD_VERTICAL_FUSIONS.values())

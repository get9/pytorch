...
from .pre_grad import PRE_GRAD_VERTICAL_FUSIONS
...
@register_graph_pattern(
    ...
    pass_dict=PRE_GRAD_VERTICAL_FUSIONS["normalization_pass"],
...
@register_graph_pattern(
    CallFunctionVarArgs(torch.split, users=MULTIPLE),
    pass_dict=PRE_GRAD_VERTICAL_FUSIONS["remove_split_with_size_one_pass"],
    extra_check=config_flag("split_cat_fx_passes"),
)
@register_graph_pattern(
    CallMethodVarArgs("split", users=MULTIPLE),
...
@register_graph_pattern(
    ...
    pass_dict=PRE_GRAD_VERTICAL_FUSIONS["merge_splits_pass"],
    extra_check=config_flag("split_cat_fx_passes"),
)
def merge_splits(
    match: Match,
...
@register_graph_pattern(
    ...
    pass_dict=PRE_GRAD_VERTICAL_FUSIONS["split_cat_pass"],
    extra_check=config_flag("split_cat_fx_passes"),
)
@register_graph_pattern(
    RepeatedExpr(
...
@register_graph_pattern(
    ...
    pass_dict=PRE_GRAD_VERTICAL_FUSIONS["unbind_stack_pass"],
    extra_check=config_flag("split_cat_fx_passes"),
)
@register_graph_pattern(
    CallFunction(
...
@register_graph_pattern(
    ...
    pass_dict=PRE_GRAD_VERTICAL_FUSIONS["merge_getitem_cat_pass"],
    extra_check=config_flag("split_cat_fx_passes"),
)
...
@register_graph_pattern(
    ...
    pass_dict=PRE_GRAD_VERTICAL_FUSIONS["mutate_cat_pass"],
    extra_check=config_flag("split_cat_fx_passes"),
)
...
@register_graph_pattern(
    ...
    pass_dict=PRE_GRAD_VERTICAL_FUSIONS["merge_stack_tahn_unbind_pass"],
    extra_check=config_flag("split_cat_fx_passes"),
)
